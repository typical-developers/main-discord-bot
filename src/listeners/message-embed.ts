...
import { Collection, GuildMember, Message, type Channel, ChannelType, PermissionFlagsBits, Attachment, EmbedBuilder, TextChannel } from 'discord.js';
...
export default class MessageListener extends Listener {
	public async fetchMessages(links: MessageLinkGroup[], member: GuildMember) {
		...
		for (let link of links) {
			...
			if (!MESSAGE.content.length && !MESSAGE.attachments.first()) continue;
